...
router.put('/articles/comment/:id', auth, checkInputComment, checkInput, commentCtrl.modifyComment); 
router.delete('/articles/comment/:id', auth,  commentCtrl.deleteComment);
